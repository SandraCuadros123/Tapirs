...
saveRDS(DATA_distance, file = "C:/Users/sandracd/OneDrive - UBC/Documents/Tapirs project/DATA_distance.RDS")

#import the distances
DATA_distance <- readRDS("C:/Users/sandracd/OneDrive - UBC/Documents/Tapirs project/DATA_distance.RDS")
...
write.csv(DATA_distance, "C:/Users/sandracd/Downloads/Data_distancetapirs.csv", row.names = FALSE)
...
ggplot(data = t_relatedness, aes(x = value, y = encounter_count, col = Relatedness)) +
  ...
  #+
#scale_x_log10()
ggsave(plot = last_plot(), filename = "C:/Users/sandracd/OneDrive - UBC/Documents/Tapirs project/Encounters_HR.png", device = NULL,
